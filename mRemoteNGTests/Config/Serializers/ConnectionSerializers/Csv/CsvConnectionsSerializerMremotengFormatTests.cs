...
public class CsvConnectionsSerializerMremotengFormatTests
{
    ...
    public void FoldersAreSerialized()
    {
        ...
        Assert.That(csv, Does.Match(container.SecurePassword.GetClearTextValue()));
    ...
    public void SerializationIncludesRawInheritedValuesIfObjectInheritsFromParentOutsideOfSerializationScope()
    {
        ...
        Assert.That(lineWithFolder3, Does.Contain(serializationTarget.SecurePassword));
    }
    ...
    private ConnectionInfo BuildConnectionInfo()
    {
        return new ConnectionInfo
        {
            ...
            Username = Username,
            Domain = Domain,
            SecurePassword = new EncryptedSecureString(Password),
    ...
    private ContainerInfo BuildContainer()
    {
        return new ContainerInfo
        {
            ...
            Username = "BlahBlah1",
            Domain = "aklkskkksh8",
            SecurePassword = new EncryptedSecureString("qweraslkdjf87")
        };
    }
}